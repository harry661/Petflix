...
export const sendSignupAttemptEmail = async (email: string, username: string, attemptEmail: string, attemptUsername: string) => {
  ...
  try {
    // Petflix Paw logo - convert SVG to base64 data URI for better email client compatibility
    // SVG encoded as base64 data URI (black for visibility on blue background)
    const svgString = '<svg width="100" height="88" viewBox="0 0 147 129" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M64.9366 17.4981C66.8477 23.8046 66.9432 29.5378 65.2233 34.6976C63.3122 40.0486 60.0634 43.5841 55.4769 45.304C50.6992 46.6417 46.0171 45.7818 41.4306 42.7241C36.8441 39.4753 33.4042 34.6976 31.1109 28.3912C29.1998 22.0847 29.1043 16.3515 30.8242 11.1916C32.7353 5.84067 35.9841 2.30521 40.5706 0.585262C45.3483 -0.752479 50.0304 0.203049 54.6169 3.45185C59.2034 6.50954 62.6433 11.1916 64.9366 17.4981ZM28.531 47.8839C31.2064 52.6616 32.3531 57.3437 31.9709 61.9302C31.3975 66.3256 29.2954 69.67 25.6644 71.9633C22.0334 73.8743 18.1157 73.8743 13.9114 71.9633C9.70705 70.2433 6.17159 66.9945 3.30501 62.2169C0.629525 57.4392 -0.421557 52.7571 0.15176 48.1706C0.533972 43.7752 2.54058 40.4308 6.17159 38.1375C9.8026 36.2265 13.7203 36.2265 17.9246 38.1375C22.1289 39.8575 25.6644 43.1063 28.531 47.8839ZM19.6445 105.789C24.8044 92.4116 30.8242 81.9963 37.704 74.5432C44.3927 67.2812 50.9859 62.2169 57.4835 59.3503C63.79 56.2926 69.0454 54.8593 73.2497 55.0504C77.454 54.8593 82.7095 56.2926 89.0159 59.3503C95.5135 62.2169 102.107 67.2812 108.795 74.5432C115.675 81.9963 121.695 92.4116 126.855 105.789C127.81 108.656 128.288 111.618 128.288 114.675V114.962C128.288 118.784 126.95 121.937 124.275 124.422C121.791 127.097 118.637 128.435 114.815 128.435C111.566 128.435 108.318 128.053 105.069 127.288L79.8429 120.982C75.4474 119.835 71.052 119.835 66.6566 120.982L41.4306 127.288C38.1818 128.053 34.933 128.435 31.6842 128.435C27.8621 128.435 24.7089 127.097 22.2245 124.422C19.549 121.937 18.2113 118.784 18.2113 114.962V114.675C18.2113 111.618 18.689 108.656 19.6445 105.789ZM120.835 71.9633C117.204 69.67 115.102 66.3256 114.529 61.9302C114.146 57.3437 115.293 52.6616 117.968 47.8839C120.835 43.1063 124.371 39.8575 128.575 38.1375C132.779 36.2265 136.697 36.2265 140.328 38.1375C143.959 40.4308 145.965 43.7752 146.348 48.1706C146.921 52.7571 145.87 57.4392 143.194 62.2169C140.328 66.9945 136.792 70.2433 132.588 71.9633C128.384 73.8743 124.466 73.8743 120.835 71.9633ZM88.7293 45.304C84.1427 43.5841 80.8939 40.0486 78.9829 34.6976C77.2629 29.5378 77.454 23.8046 79.5562 17.4981C81.6584 11.1916 85.0027 6.50954 89.5893 3.45185C94.1758 0.203049 98.8579 -0.752479 103.636 0.585262C108.222 2.30521 111.471 5.84067 113.382 11.1916C115.102 16.3515 115.006 22.0847 113.095 28.3912C110.802 34.6976 107.362 39.4753 102.776 42.7241C98.189 45.7818 93.5069 46.6417 88.7293 45.304Z" fill="#0F0F0F"/></svg>';
    const svgBase64 = Buffer.from(svgString).toString('base64');
    const petflixPawLogo = `<img src="data:image/svg+xml;base64,${svgBase64}" alt="Petflix" width="100" height="88" style="display: block; margin: 0 auto;" />`;
