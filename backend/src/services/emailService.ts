        ...
        <table role="presentation" style="width: 100%; max-width: 600px; background-color: #1a1a1a; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);">
          ...
          <tr>
            <td style="background-color: #ADD8E6; padding: 40px 20px; text-align: center;">
              <div style="width: 60px; height: 60px; margin: 0 auto 20px; background-color: rgba(0, 0, 0, 0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2L2 7L12 12L22 7L12 2Z" fill="#0F0F0F"/>
                  <path d="M2 17L12 22L22 17" stroke="#0F0F0F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M2 12L12 17L22 12" stroke="#0F0F0F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
          ...
          <tr>
            <td style="padding: 40px 30px; background-color: #1a1a1a;">
              <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: bold; color: #ADD8E6;">Security Alert</h1>
              ...
              <ul style="margin: 0 0 24px; padding-left: 20px; font-size: 16px; line-height: 1.8; color: rgba(255, 255, 255, 0.9);">
