    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" style="width: 100%; max-width: 600px; background-color: #1a1a1a; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);">
          ...
          <tr>
            <td style="padding: 40px 30px; background-color: #1a1a1a;">
              <h1 style="margin: 0 0 20px; font-size: 24px; font-weight: bold; color: #ADD8E6;">Reset Your Password</h1>
              <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: rgba(255, 255, 255, 0.9);">
                Hello ${username},
              </p>
              <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: rgba(255, 255, 255, 0.9);">
              ...
              <div style="text-align: center; margin: 32px 0;">
                <a href="${resetUrl}" style="display: inline-block; padding: 14px 28px; background-color: #ADD8E6; color: #0F0F0F; text-decoration: none; border-radius: 4px; font-weight: bold; font-size: 16px;">Reset Password</a>
              </div>
              <p style="margin: 24px 0 0; font-size: 14px; line-height: 1.6; color: rgba(255, 255, 255, 0.7);">
